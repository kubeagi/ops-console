...
class ModelServiceDetail$$Page extends React.Component {
  ...
  constructor(props, context) {
    ...
    this.state = { delModalVisible: false, detail: {}, loading: false, okLoading: false };
  }
          ...
          >
            ...
            >
              <Col __component_name="Col" span={16}>
                <Row __component_name="Row" align="middle" gutter={[20, 0]} wrap={true}>
                      ...
                      >
                        ...
                        >
                          ...
                          <Col __component_name="Col" span={18}>
                            <Row __component_name="Row" align="middle" gutter={[0, 0]} wrap={true}>
                              <Col
                                __component_name="Col"
                                flex="80px"
                                span=""
                              ...
                              <Col __component_name="Col" style={{ marginLeft: '-20px' }}>
                                <Typography.Time
                        ...
                        {__$$evalArray(() => [
                          ...
                          (__$$context => (
                            <Card
                              ...
                              type="default"
                            >
                              <Row __component_name="Row" align="top" justify="start" wrap={false}>
                                <Col __component_name="Col">
                                  <Image
                                    __component_name="Image"
                                    fallback=""
                                ...
                                <Col __component_name="Col">
                                  <Row __component_name="Row" wrap={true}>
                                    ...
                                    <Col __component_name="Col" style={{ marginTop: '-8px' }}>
                                      <Typography.Paragraph
                                        code={false}
                                        delete={false}
                                        disabled={false}
