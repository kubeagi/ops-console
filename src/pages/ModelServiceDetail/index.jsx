    ...
    return (
      <Page style={{ position: 'relative' }}>
        <Button.Back
          type="ghost"
          title={__$$eval(
            () => `${['外部', '本地'][Number(this.history.query?.type === 'local')]}数据模型详情`
          )}
        ...
        >
          <Row wrap={true} align="middle" justify="space-between" __component_name="Row">
                      ...
                      <Row wrap={true} style={{ width: '100%' }} __component_name="Row">
                        <Col span={6} __component_name="Col">
                          <Status
                            id="done"
                            types={[
                              { id: 'disabled', type: 'disabled', children: '未知' },
                              { id: 'done', type: 'success', children: '已发布' },
                            ]}
            ...
            <Descriptions
              ...
              items={[
                ...
                },
                {
                  key: 'l91hzi41kwn',
                  span: 1,
                  label: this.i18n('i18n-n4a25wxc') /* API地址 */,
                  children: (
                    <Typography.Text
                      style={{ fontSize: '' }}
                      strong={false}
                ...
                },
                {
                  ...
                  label: this.i18n('i18n-z8fujdli') /* 关联模型应用 */,
                  children: (
                    <Flex wrap="wrap" justify="space-between" __component_name="Flex">
                      <Card
                        size="default"
                        type="default"
                        style={{ width: 'calc(50% - 10px)', marginBottom: '20px' }}
