    ...
    return (
      <Page>
        <Modal
          ...
          maskClosable={false}
          onCancel={function () {
            return this.closeBaseInfoModal.apply(
              this,
              ...
              },
              {
                ...
                children: (
                  <Typography.Text
                    ...
                    style={{ fontSize: '' }}
                  >
                    {__$$eval(() => this.getKnowledge()?.chunkSize + ' 字符' || '-')}
                  </Typography.Text>
                ),
                key: '25nyuq5iamm',
                label: '文本分段长度',
              ...
              },
              {
                children: (
                  <Typography.Text
                    ...
                    style={{ fontSize: '' }}
                  >
                    {__$$eval(() => this.getKnowledge()?.chunkOverlap + ' 字符' || '-')}
                  </Typography.Text>
                ),
                key: 'jyxi1y2h6ia',
                label: '分段重叠长度',
                  ...
                  <UnifiedLink
                    ...
                    to={__$$eval(() =>
                      (() => {
                        ...
                        }?type=${knowledge?.embedderType === '3rd_party' ? 'external' : 'local'}`;
                      })()
                    )}
                  >
                    {__$$eval(() =>
                                ...
                                to={__$$eval(() =>
                                  (() => {
                                    ...
                                    return `/kubeagi-portal/model-service/detail/${
                                      ...
                                      knowledge?.embedderType === '3rd_party' ? 'external' : 'local'
                                    }`;
                                  })()
                                )}
                              >
                ...
                <Col __component_name="Col" style={{ lineHeight: '64px' }}>
                  <Dropdown.Button
                    ...
                    menu={{
                      ...
                      onClick: function () {
                        return this.onDropdownMenuClick.apply(
                          this,
                          Array.prototype.slice.call(arguments).concat([])
                        );
                      }.bind(this),
                          ...
                          (__$$context => (
                            <Status
                              ...
                              types={[
                                ...
                                { children: '已完成', id: 'Succeeded', type: 'success' },
                                { children: '处理中', id: 'Processing', type: 'primary' },
                              ]}
                            />
                          ))(__$$createChildContext(__$$context, { text, record, index })),
                        title: '状态',
